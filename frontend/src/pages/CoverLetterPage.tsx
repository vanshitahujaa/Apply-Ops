...
const toneOptions = [
    { id: 'formal', label: 'Formal', description: 'Professional and traditional', icon: '👔' },
    { id: 'casual', label: 'Casual', description: 'Friendly and approachable', icon: '😊' },
    { id: 'startup', label: 'Startup', description: 'Innovative and energetic', icon: '🚀' },
    { id: 'corporate', label: 'Corporate', description: 'Polished and executive', icon: '🏢' },
]
